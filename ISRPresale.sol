...
contract Crowdsale is CrowdsaleBase {
  ...
  function Crowdsale(address _token, PricingStrategy _pricingStrategy, address _multisigWallet, uint _start, uint _end) CrowdsaleBase(_token, _pricingStrategy, _multisigWallet, _start, _end) public {
  }
...
contract AllocatedCrowdsale is AllocatedCrowdsaleMixin, Crowdsale {
  ...
  function AllocatedCrowdsale(address _token, PricingStrategy _pricingStrategy, address _multisigWallet, uint _start, uint _end, address _beneficiary) Crowdsale(_token, _pricingStrategy, _multisigWallet, _start, _end) public AllocatedCrowdsaleMixin(_beneficiary) {
